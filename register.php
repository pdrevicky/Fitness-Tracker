            ...
            <div id="register_form">
                <form action="register.php" method="POST">
                    <input type="text" name="register_first_name" placeholder="First Name" value="<?php
                                                                                                    ...
                                                                                                    ?>" required>
                    <br>
                    <?php if (in_array("FIRST_NAME_NUMBER_OF_CHARACTERS_ERROR", $error_array)) echo "Yout first name must be between 2 and 25 characters <br>"; ?>
                    ...
                    <input type="text" name="register_last_name" placeholder="Last Name" value="<?php
                                                                                                ...
                                                                                                ?>" required>
                    <br>
                    <?php if (in_array("LAST_NAME_NUMBER_OF_CHARACTERS_ERROR", $error_array)) echo "Your last name must be between 2 and 25 characters <br>"; ?>
                    ...
                    <br>
                    <?php if (in_array("PASSWORD_DO_NOT_MATCH", $error_array)) echo "Your password do not match <br>";
                    else if (in_array("PASSWORD_CAN_ONLY_CONTAIN_ENGLISH_CHARACTERS_AND_NUMBERS", $error_array)) echo "Your password can on contain english characters and numbers <br>";
                    else if (in_array("PASSWORD_LENGHT", $error_array)) echo "Your password must by between 5 and 30 characters <br>"; ?>
